@section('sidebar')
<div class="flex flex-col h-full px-4 py-8 bg-blue-50 border-r">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            href="#">
                ...
                <span class="ml-2 font-medium">総合トップ</span>
            </a>
            ...
            @auth
                ...
                href="{{ route('user.index', ['id' => $user_id]) }}">
                    ...
                    <span class="ml-2 font-medium">マイページ</span>
                </a>
                ...
                href="#">
                    ...
                    <span class="ml-2 font-medium">マイニュース</span>
                </a>
            @endauth
            ...
            @foreach ($categories as $category)
                ...
                href="{{ route('top.article.category', ['category_id' => $category->id]) }}">
                    <span>-</span>
                    <span class="ml-2 font-medium">{{ $category->category_name }}</span>
                </a>
            @endforeach
        </nav>
    </div>
